  ...
  describe 'SemanticFormBuilder' do
    ...
    describe '#input' do
      ...
      describe ':as => :date' do
        ...
        it 'should have a legend containing a label' do
      ...
      describe ':as => :date, :as_span => true' do
        before do
          @new_post.stub!(:publish_at)
          @new_post.stub!(:column_for_attribute).and_return(mock('column', :type => :date))

          semantic_form_for(@new_post) do |builder|
            concat(builder.input(:publish_at, :as => :date, :as_span => true))
            @builder = builder
          end
        end
        
        it 'should have a legend containing a span' do
          output_buffer.should have_tag('form li.date fieldset legend span', /Publish at/)
        end
      end
